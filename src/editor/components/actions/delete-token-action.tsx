...
interface DeleteTokenActionProps {
  open: boolean,
  setOpen: ( open: boolean ) => void
  onDelete: () => void
}

export const DeleteTokenAction = ( { open, setOpen, onDelete }: DeleteTokenActionProps ): JSX.Element => (
      ...
      <div className="bg-white dark:bg-gray-900 shadow sm:rounded-lg z-30 relative">
        <div className="px-4 py-5 sm:p-6">
          ...
          <Dialog.Description className="mt-2 max-w-xl text-sm text-gray-500">
            Once you delete this token, you will will not be able to recover it.
          </Dialog.Description>
